const routes = {
  ...
  cardio: {
    ...
    deck: 'Сердечно-сосудистый риск можно снижать год за годом, ещё до симптомов. Давление, LDL, ApoB и семейная история складываются в личную картину и подходящее решение.',
    image: 'assets/hero-cardio.webp',
    signal: ['Главный результат', 'Риск ниже, активных лет больше', 'LDL + ApoB + давление'],
    ...
    facts: [
      ...
      ['Понятная цель', 'Врач определит, какой уровень LDL или ApoB будет значим с учётом истории здоровья.', '43%'],
      ['Подходящий способ снижения', 'Питание, движение и лекарства, включая PCSK9‑направленные варианты, сопоставляются по ожидаемой пользе в конкретной ситуации.', '62%'],
